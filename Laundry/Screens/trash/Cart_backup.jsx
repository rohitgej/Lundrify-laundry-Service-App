...
// }
  ...
  const handleSubmit = async () => {
    try {
      ...
      const response = await fetch(
        'https://newlaundryapp.demodev.shop/api/checkout',
        requestOptions,
      );
      ...
      if (result.message==="Order placed successfully") {
        ...
        console.warn(result.error || 'Failed to checkout.');
      }
    } catch (error) {
      console.error(error);
  ...
  const handleRemoveCoupon = async () => {
    try {
      ...
      const response = await fetch(
        'https://newlaundryapp.demodev.shop/api/remove-coupon',
        requestOptions,
      );
      const result = await response.json();
  ...
  const fetchPaymentMethod = async () => {
    try {
      const response = await fetch(
        'https://newlaundryapp.demodev.shop/api/viewtransactionmethod',
      );
      const result = await response.json();
