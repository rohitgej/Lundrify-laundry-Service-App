...
const Categories = ({ route, navigation }) => {
  ...
  const fetchCategories = async () => {
    try {
      const response = await fetch("https://newlaundryapp.demodev.shop/api/viewcategory");
  ...
  const fetchLaundryTypes = async () => {
    try {
      const response = await fetch("https://newlaundryapp.demodev.shop/api/viewlaundrytype");
      const result = await response.json();
  ...
  const fetchItems = async () => {
    try {
      const response = await fetch("https://newlaundryapp.demodev.shop/api/viewitem");
      const result = await response.json();
  ...
  const handleCartButtonClick = async () => {
    ...
    try {
      const response = await fetch("https://newlaundryapp.demodev.shop/api/addtocart", requestOptions);
